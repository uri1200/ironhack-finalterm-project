  ...
  <div class="h-screen flex imagen">
    <div class="flex p-16 justify-center items-center rounded-xl bg-white m-auto">
      <form class="bg-white">
        ...
        <p class="text-sm font-normal text-center text-gray-600 mb-7">Register your account!</p>
        ...
        <form @submit.prevent="signUp" class="form-sign-in">
          ...
          <div class="flex items-center border-2 py-2 px-3 rounded-2xl mb-4">
            ...
            <input type="password" class="input-field pl-2 outline-none border-none" placeholder="Password" id="password" v-model="password" required>
          </div>
          <div class="flex items-center border-2 py-2 px-3 rounded-2xl">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd" />
            </svg>
            <input type="password" class="input-field pl-2 outline-none border-none" placeholder="Confirm Password" id="confirmPassword" v-model="confirmPassword" required>
          </div>
          <button type="submit" class="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Register Account</button>
        </form>
